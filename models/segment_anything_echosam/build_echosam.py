...
def build_echosam_vit_b(args, checkpoint=None):
    return _build_echosam(
        args,
...
echosam_model_registry = {
    "vit_b": build_echosam_vit_b,
}
...
def load_from2(samus, sam_dict, image_size, patch_size): # load the positional embedding
    samus_dict = samus.state_dict()  # 空的
    ...
    # for mlp in samus.mask_decoder.output_hypernetworks_mlps:
